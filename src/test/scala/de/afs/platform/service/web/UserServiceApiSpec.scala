...
import spray.http.{ContentTypes, HttpEntity, OAuth2BearerToken, StatusCodes, HttpMethods}
import spray.httpx.SprayJsonSupport._
import spray.routing._
import spray.testkit.Specs2RouteTest


class UserServiceApiSpec extends Specification with Specs2RouteTest with UUIDMixIn {
  isolated
